...
var Chiasm = require("chiasm"),
    ...
    ChiasmLayout = require('chiasm-layout'),
    ChiasmLinks = require('chiasm-links'),
    ChiasmDsvDataset = require('chiasm-dsv-dataset'),
    ChiasmDataReduction = require('chiasm-data-reduction');
